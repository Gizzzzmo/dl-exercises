...
class Conv(Layer):
    ...
    def get_optimizer(self):
        return OptimizerWrapper(self._optimizer_kernels, self._optimizer_biases)
    ...
    def backward(self, error_tensor):
        ...
        if not self.accumulate_gradients or self._gradient_weights is None:
        ...
        if self._optimizer_kernels is not None and not self.accumulate_gradients:
            self.update_weights()
